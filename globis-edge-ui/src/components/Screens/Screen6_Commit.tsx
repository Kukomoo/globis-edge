...
export function Screen6_Commit() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Finalize Intake Record</h1>
      ...
      {d && (
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div>
              <p className="text-xs text-slate-500 mb-0.5">Auditor Status</p>
            ...
            <div>
              <p className="text-xs text-slate-500 mb-0.5">Artifacts</p>
              <p className="font-semibold text-slate-800 text-sm">{state.artifacts.length}</p>
            </div>
          </div>

          {blockedFields.length > 0 && (
            <div className="mt-4 pt-4 border-t border-slate-100">
              <p className="text-xs text-slate-500 mb-2">Quarantined fields (not exported)</p>
      ...
      <div className="rounded-xl border border-slate-200 bg-white overflow-hidden">
        ...
        <div className="p-6 space-y-3">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-slate-900 text-sm"><span aria-hidden="true">✅ </span>Commit Record</p>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-slate-900 text-sm"><span aria-hidden="true">🗄️ </span>Quarantine for Review</p>
              <p className="text-xs text-slate-500 mt-0.5 leading-relaxed">
          ...
          <div className="pt-2">
            <label className="block text-xs font-semibold text-slate-600 mb-1.5">
              Caseworker Notes <span className="text-slate-500 font-normal">(optional)</span>
            </label>
            <textarea
              value={notes}
          ...
          <div className="p-3.5 bg-slate-50 border border-slate-100 rounded-xl">
            <p className="text-xs text-slate-500 leading-relaxed">
              <strong className="text-slate-600"><span aria-hidden="true">⚖️ </span>Accountability:</strong> This decision is logged
